(function ($) {
    ...
    if ($.fn.meanmenu) {
        let image = `http://127.0.0.1:8000/customer_asset/logo.jpg`;
        $('nav#dropdown').meanmenu({
            siteLogo: `<div class='mobile-menu-nav-back'><a class='logo-mobile' href=''><img src='${image}' alt='logo' class='img-fluid' width="50"/></a></div>`
        });
    }
